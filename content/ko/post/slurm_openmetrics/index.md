...
| `slurm_node_cpu_alloc{node="..."}` | `slurm_node_cpus_alloc{node="..."}` | Per-node CPU |
| `slurm_node_mem_alloc{node="..."}` | `slurm_node_memory_alloc_bytes{node="..."}` | Per-node memory |
| `slurm_scheduler_mean_cycle` | `slurm_sched_mean_cycle` | Scheduler cycle time |
| `slurm_scheduler_backfilled_jobs_since_start_total` | `slurm_backfilled_jobs` | Backfilled jobs count |
