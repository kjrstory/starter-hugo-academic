...
예를 들어 프로그래머에게는 아래와 같은 역할을 프롬프트로 부여하는 것입니다.
...
저는 ChatDev를 한국어로도 사용가능한 가에 대해 관심을 가지게 되었습니다.
...
ChatGPT에서도 한국어로 질문을 해도 영어로 답변하는 경우가 있습니다.
...
대체로 잘 작성을 하였습니다만 예제라고 하면서 소스 코드를 보여주는것은 명백히 잘못 작성이 된것입니다.
...
또 ChatDev에서 현재까지의 예제는 간단한 SW밖에 없고 이런 간단한 SW가 실제 사용되는 일은 없을겁니다.
