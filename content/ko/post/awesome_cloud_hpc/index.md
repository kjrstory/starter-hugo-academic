...
6개월 전에 Cloud HPC 주제로 여러 상품들을 정리한 글[link](https://kjrstory.netlify.app/ko/post/cloud_hpc_list/)을 작성 했습니다. 이런 즐겨찾기 목록을 정리한 포스트의 문제는 지속적으로 변화가 있다는 것입니다. 블로그의 글도 수정이 가능하지만 블로그 글은 Publish라는 단어를 쓰는 것처럼 수정이 자주 이루어지는 것을 고려한 것은 아닙니다.
